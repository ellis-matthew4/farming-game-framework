...
@onready var items = [
	Tool.new("Hoe", -1, "res://assets/items/hoe.png", "sample", 1),
	Tool.new("Sickle", -1, "res://assets/items/sickle.png", "sample", 2),
	Tool.new("Watering Can", -1, "res://assets/items/watering_can.png", "sample", 3),
	Tool.new("Hammer", -1, "res://assets/items/hammer.png", "sample", 4),
	Tool.new("Axe", -1, "res://assets/items/axe.png", "sample", 5),
